...
if __name__=='__main__':
    ...
    train_dataset = data_load('data/seed_{}/train.pkl'.format(seed), 'train')
    test_dataset = data_load('data/seed_{}/test.pkl'.format(seed), 'test')
    val_dataset = data_load('data/seed_{}/val.pkl'.format(seed), 'val')
